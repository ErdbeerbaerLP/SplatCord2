...
public class StatusCommand extends BaseCommand {
    ...
    public void execute(SlashCommandInteractionEvent ev) {
        ...
        b.addField("Splatoon 1 - Nintendo Network", Main.splatoon1NintendoStatus ? ":blue_circle: " + lang.botLocale.online+":headstone:" : ":red_circle: " + lang.botLocale.offline+ ":headstone:", false);
        ...
        b.addField("Splatoon 1 - Splatfestival", Main.splatoon1SplatfestivalStatus ? ":green_circle: " + lang.botLocale.online : ":red_circle: " + lang.botLocale.offline, false);
        ...
        if (dbAlive) {
            ...
            String stats =
                    lang.botLocale.cmdStatusStatsServers + Main.bot.jda.getGuilds().size() + "\n" +
                            lang.botLocale.cmdStatusStatsUsers + Main.bot.jda.retrieveApplicationInfo().complete().getUserInstallCount() + "\n" +
